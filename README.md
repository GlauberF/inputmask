...
Inputmask é uma biblioteca javascript que cria uma máscara de entrada. A máscara de entrada pode ser usada com javascript vanilla, jQuery e jqlite.

Uma máscara de entrada ajuda o usuário, garantindo um formato predefinido. Isso pode ser útil para datas, números, números de telefone, ...
...
<script src="bower_components/inputMaskGlauber/dist/jquery.inputmask.bundle.js"></script>
<script src="bower_components/inputMaskGlauber/dist/inputmask/phone-codes/phone.js"></script>
<script src="bower_components/inputMaskGlauber/dist/inputmask/phone-codes/phone-be.js"></script>
<script src="bower_components/inputMaskGlauber/dist/inputmask/phone-codes/phone-ru.js"></script>
```
Para extensões individuais. (com jQuery como dependencylib)

```html
<script src="jquery.js"></script>
<script src="bower_components/inputMaskGlauber/dist/inputmask/inputmask.js"></script>
<script src="bower_components/inputMaskGlauber/dist/inputmask/inputmask.extensions.js"></script>
<script src="bower_components/inputMaskGlauber/dist/inputmask/inputmask.numeric.extensions.js"></script>
<script src="bower_components/inputMaskGlauber/dist/inputmask/inputmask.date.extensions.js"></script>
<script src="bower_components/inputMaskGlauber/dist/inputmask/inputmask.phone.extensions.js"></script>
<script src="bower_components/inputMaskGlauber/dist/inputmask/jquery.inputmask.js"></script>
<script src="bower_components/inputMaskGlauber/dist/inputmask/phone-codes/phone.js"></script>
<script src="bower_components/inputMaskGlauber/dist/inputmask/phone-codes/phone-be.js"></script>
<script src="bower_components/inputMaskGlauber/dist/inputmask/phone-codes/phone-ru.js"></script>
```

Para extensões individuais. (com dependencylib de js vanilla)
```html
<script src="bower_components/inputMaskGlauber/dist/inputmask/dependencyLibs/inputmask.dependencyLib.js"></script>
<script src="bower_components/inputMaskGlauber/dist/inputmask/inputmask.js"></script>
<script src="bower_components/inputMaskGlauber/dist/inputmask/inputmask.extensions.js"></script>
<script src="bower_components/inputMaskGlauber/dist/inputmask/inputmask.numeric.extensions.js"></script>
<script src="bower_components/inputMaskGlauber/dist/inputmask/inputmask.date.extensions.js"></script>
...
Se você gosta de vincular automaticamente a máscara de entrada às entradas marcadas com os atributos data-inputmask ... você também pode querer incluir o inputmask.binding.js

```html
<script src="bower_components/inputMaskGlauber/dist/inputmask/bindings/inputmask.binding.js"></script>
```


#### Install the package
```
bower install inputmaskglauber --save
```
